(function () {
    var unifiedPushClient,
        ...
        unifiedPushUrl = "https://safari-push-test.herokuapp.com/";
    ...
    document.body.onload = function() {
        ...
        if ('safari' in window && 'pushNotification' in window.safari) {
            var permissionData = window.safari.pushNotification.permission('web.com.iomedia.safaripushtest');
    ...
    var checkRemotePermission = function (permissionData) {
        if (permissionData.permission === 'default') {
            ...
            window.safari.pushNotification.requestPermission(
                'https://safari-push-test.herokuapp.com/', // The web service URL.
                'web.com.iomedia.safaripushtest',     // The Website Push ID.
